...
export default function About() {
  return (
    <>
      <div className="md:py-20 py-10 px-4 md:px-20 xl:px-40">
        <AnimateToView className=" w-full">
          <h1 className="md:text-[40px] text-[30px] px-2 md:px-0 text-DG">We handle everything for you.</h1>
        </AnimateToView>
        <div className="flex mt-5">
          <div>
            ...
            <AnimateToView className="grid grid-cols-2 md:grid-cols-4 gap-16 mt-12 ml-8">
              <div>
                <h1 className="text-[40px] text-DG">100K+</h1>
                <p className="text-lg md:text-xl font-light text-DG">Customers</p>
              </div>
              <div>
                <h1 className="text-[40px] text-DG">50+</h1>
                <p className="text-lg md:text-xl font-light text-DG">Products</p>
              </div>
              <div>
                <h1 className="text-[40px] text-DG">1000+</h1>
                <p className="text-lg md:text-xl font-light text-DG">Consultancies</p>
              </div>
              <div>
                <h1 className="text-[40px] text-DG">100+</h1>
                <p className="text-lg md:text-xl font-light text-DG">Projects</p>
              </div>
            </AnimateToView>
            <div className="ml-10 max-w-[200px] mt-10">
