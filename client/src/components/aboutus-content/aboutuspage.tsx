    ...
    <div className="bg-DB px-4 xl:px-40 md:px-20 pt-40 pb-20 flex flex-col gap-20">
        ...
        <div className="flex flex-col-reverse lg:flex-row items-center md:items-start gap-8">
          <div className=" lg:w-1/2">
            ...
            <p className="text-gray-200">
              ...
              <br />
              <br />
              Products: We offer tailored products to meet the specific needs of
              ...
              <br />
              <br />
              Services: Our comprehensive services cover animal health
              ...
              <br />
              <br />
              Training and Consultancy: We provide training and consultancy
              ...
              <br />
              <br />
              Project Development: In addition to our core offerings, we also
          ...
          <div className="w-full lg:w-1/2 h-full items-center justify-center">
      ...
      <div className=" flex flex-col gap-12">
        ...
        <div className=" w-full flex flex-col lg:flex-row gap-12">
          <AnimateToView className="w-full flex items-center justify-center">
            <div>
              <img
                src="/aboutus/chairman.png"
                alt="chairman"
                className="h-[260px] border p-2"
              />
              <div className="flex flex-col mt-4">
                ...
                <div className=" flex items-center w-full gap-4">
                  <a
                    ...
                    target="_blank"
                  >
                    <FaLinkedin className="text-2xl mt-2 text-LG hover:text-white" />
                  </a>
                  <p className="mt-2 text-LG text-sm">
      ...
      <div className="flex flex-col items-center justify-center xl:px-40">
        ...
        <div className=" grid grid-cols-2 lg:grid-cols-3 gap-x-4 gap-y-8 justify-between gap-10">
          {team.map((member, index) => (
            <AnimateToView
              key={index}
              className="flex flex-col justify-center items-center"
            >
              <div className="w-full min-h-80 h-full overflow-hidden">
                <img
                  src={member.image}
